...
class C_WeaponStunStickPlayer : public C_BaseHLBludgeonWeapon
{
	DECLARE_CLASS( C_WeaponStunStickPlayer, C_BaseHLBludgeonWeapon );
	
public:

	C_WeaponStunStickPlayer();
	...
	C_WeaponStunStickPlayer( const C_WeaponStunStickPlayer & );
...
// C_WeaponStunStickPlayer
//-----------------------------------------------------------------------------
STUB_WEAPON_CLASS_IMPLEMENT( weapon_stunstick_player, C_WeaponStunStickPlayer );

IMPLEMENT_CLIENTCLASS_DT( C_WeaponStunStickPlayer, DT_WeaponStunStickPlayer, CWeaponStunStickPlayer )
...
// Constructor
//-----------------------------------------------------------------------------
C_WeaponStunStickPlayer::C_WeaponStunStickPlayer( void )
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void C_WeaponStunStickPlayer::Spawn()
{
	Precache();
...
void C_WeaponStunStickPlayer::Precache()
{
	BaseClass::Precache();
...
//-----------------------------------------------------------------------------
float C_WeaponStunStickPlayer::GetDamageForActivity( Activity hitActivity )
{
	return 40.0f;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_WeaponStunStickPlayer::ImpactEffect( trace_t &traceHit )
{	
	CEffectData	data;
...
//-----------------------------------------------------------------------------
void C_WeaponStunStickPlayer::SetStunState( bool state )
{
	m_bActive = state;
...
//-----------------------------------------------------------------------------
bool C_WeaponStunStickPlayer::Deploy( void )
{
	SetStunState( true );
...
// Purpose: 
//-----------------------------------------------------------------------------
bool C_WeaponStunStickPlayer::Holster( CBaseCombatWeapon *pSwitchingTo )
{
...
// Input  : &vecVelocity - 
//-----------------------------------------------------------------------------
void C_WeaponStunStickPlayer::Drop( const Vector &vecVelocity )
{
	SetStunState( false );
}
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool C_WeaponStunStickPlayer::GetStunState( void )
{
	return m_bActive;
}
...
//-----------------------------------------------------------------------------
void C_WeaponStunStickPlayer::SetupAttachmentPoints( void )
{
...
//-----------------------------------------------------------------------------
int C_WeaponStunStickPlayer::DrawModel( int flags )
{
	if ( ShouldDraw() == false )
		return 0;
...
//-----------------------------------------------------------------------------
void C_WeaponStunStickPlayer::ClientThink( void )
{
	if ( InSwing() == false )
	{
...
//-----------------------------------------------------------------------------
void C_WeaponStunStickPlayer::OnDataChanged( DataUpdateType_t updateType )
{
...
//-----------------------------------------------------------------------------
RenderGroup_t C_WeaponStunStickPlayer::GetRenderGroup( void )
{
...
// Purpose: Tells us we're always a translucent entity
//-----------------------------------------------------------------------------
bool C_WeaponStunStickPlayer::InSwing( void )
{
...
//-----------------------------------------------------------------------------
void C_WeaponStunStickPlayer::DrawThirdPersonEffects( void )
{
	Vector	vecOrigin;
	QAngle	vecAngles;
	float	color[3];
...
// Purpose: Draw our special effects
//-----------------------------------------------------------------------------
void C_WeaponStunStickPlayer::DrawFirstPersonEffects( void )
{
	Vector	vecOrigin;
	QAngle	vecAngles;
	float	color[3];
...
// Purpose: Draw our special effects
//-----------------------------------------------------------------------------
void C_WeaponStunStickPlayer::DrawEffects( void )
{
	if ( ShouldDrawUsingViewModel() )
	{
...
//-----------------------------------------------------------------------------
void C_WeaponStunStickPlayer::ViewModelDrawn( C_BaseViewModel *pBaseViewModel )
{
