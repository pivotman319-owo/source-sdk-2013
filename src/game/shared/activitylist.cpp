...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY ( ACT_MP_PRONE_DEPLOYED_IDLE );
	REGISTER_SHARED_ACTIVITY ( ACT_MP_PRONE_DEPLOYED );
	REGISTER_SHARED_ACTIVITY ( ACT_MP_PRONE_CRAWL_DEPLOYED );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_MP_ATTACK_PRONE_GRENADE );	
